        ...
        if (commandSender instanceof ProxiedPlayer) {
            ...
            if (args.length < 1) {
                String msg = BungeeMain.getInstance()
                    .getConfig()
                    .getString(
                        "Messages.Commands.Fakemessage.NoArgument",
                        "&6Arguments:\n" +
                        "- &cfakejoin\n" +
                        "- &cfakequit\n" +
                ...
                if (
                    args[0].equalsIgnoreCase("fakejoin") ||
                    args[0].equalsIgnoreCase("fj")
                ) {
                    ...
                    args[0].equalsIgnoreCase("fakequit") ||
                    args[0].equalsIgnoreCase("fq")
                ) {
                    String message = MessageHandler.getInstance()
                    ...
                    args[0].equalsIgnoreCase("fakeswitch") ||
                    ...
                    if (args.length < 3) {
                        String msg = BungeeMain.getInstance()
                            .getConfig()
                            .getString(
                                "Messages.Commands.Fakemessage.FakeSwitchNoArgument",
                                "&6Arguments:\n" +
                                "- &cfakejoin\n" +
                                "- &cfakequit\n" +
                                "- &cfakeswitch&6 (to) (from)\n" +
                    ...
                    if (!player.hasPermission("networkjoinmessages.silent")) {
                        msg = BungeeMain.getInstance()
                            .getConfig()
                            .getString(
                                "Messages.Commands.Fakemessage.ToggleSilentNoPerm",
                                "&cYou do not have the permission to join the server silently."
                            );
                        TextComponent message = new TextComponent(
                            HexChat.translateHexCodes(msg)
                        );
                        player.sendMessage(message);
                        return;
                    } else {
                        ...
                        msg = BungeeMain.getInstance()
                            .getConfig()
                            .getString(
                                "Messages.Commands.Fakemessage.ToggleSilent",
                        ...
                        player.sendMessage(message);
                        Storage.getInstance()
                            .setAdminMessageState(player, state);
                        return;
                    }
                }
            }
            ...
            default:
                return ImmutableList.of(
                    BungeeMain.getInstance()
                        .getConfig()
                        .getString(
                            "Messages.Commands.NoMoreArgumentsNeeded",
