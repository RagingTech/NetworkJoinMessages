...
public class BungeeMain extends Plugin {
    ...
    public void onEnable() {
        ...
        if (
            ...
            getProxy()
                .getPluginManager()
                .registerListener(this, new VanishListener());
        }
        if (
            ProxyServer.getInstance()
                .getPluginManager()
    ...
    private void loadConfig() {
        ...
        try {
            ...
            configuration = ConfigurationProvider.getProvider(
    ...
    public void SilentEvent(String type, String name, String from, String to) {
        ...
        switch (type) {
            case "MOVE":
                message = getConfig()
                    .getString(
                        "Messages.Misc.ConsoleSilentMoveEvent",
            ...
            case "QUIT":
                message = getConfig()
                    .getString(
                        "Messages.Misc.ConsoleSilentQuitEvent",
            ...
            case "JOIN":
                message = getConfig()
                    .getString(
                        "Messages.Misc.ConsoleSilentJoinEvent",
